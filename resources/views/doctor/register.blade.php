                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('doctor.register') }}">
                        ...
                        <div class="form-group{{ $errors->has('Doctor_regNo') ? ' has-error' : '' }}">
                            <label for="Doctor_regNo" class="col-md-4 control-label">Doctor_regNo</label>

                            <div class="col-md-6">
                                <input id="Doctor_regNo" type="text" class="form-control" name="Doctor_regNo" value="{{ old('Doctor_regNo') }}" required autofocus>

                                @if ($errors->has('Doctor_regNo'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('Doctor_regNo') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('phonenumber') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($errors->has('phonenumber'))
                                    <span class="help-block">phonenumber
